  ...
  return (
    ...
    >
      <linearGradient
        ...
        y2="8.274"
      >
        <stop offset="0" stopColor="#f80314" />
        <stop offset="1" stopColor="#fed59c" />
      </linearGradient>
      <linearGradient id="lg1">
        <stop offset="0" stopColor="#fe652b" />
      ...
      <linearGradient
        ...
        y2="8.274"
      >
        <stop offset="0" stopColor="#e2dec3" />
        <stop offset=".9944" stopColor="#fff" />
      </linearGradient>
      <linearGradient
        id="SVGID_4_"
        gradientUnits="userSpaceOnUse"
      ...
      <g id="_x30_4_geomentry">
        <g>
          <path
            d="m416.201 87.849-303.344 300.24-88.618 26.698c-6.565 1.978-12.666-4.198-10.608-10.739l27.808-88.365 303.345-300.239c9.787-9.653 25.634-9.545 35.287.242l36.372 36.875c9.654 9.787 9.545 25.635-.242 35.288z"
            fill="url(#SVGID_1_)"
          />
          <path
            d="m112.857 388.089-88.618 26.698c-6.565 1.978-12.666-4.198-10.608-10.739l27.808-88.365z"
            fill="url(#SVGID_2_)"
          />
          <path
            d="m376.404 127.103 39.797-39.254c9.787-9.653 9.896-25.501.242-35.288l-36.372-36.875c-9.653-9.787-25.5-9.896-35.287-.242l-39.797 39.254z"
            fill="url(#SVGID_3_)"
          />
          <path
            d="m468.675 105.343-368.275 368.221c-11.093 11.147-3.231 30.102 12.493 30.102h368.275c9.747 0 17.609-7.862 17.609-17.609v-368.274c-.001-15.67-19.009-23.586-30.102-12.44zm-47.172 308.987c0 6.677-5.385 12.062-12.062 12.062h-123.423c-10.77 0-16.155-12.978-8.616-20.57l123.53-123.422c7.593-7.647 20.57-2.262 20.57 8.508v123.422z"
            fill="url(#SVGID_4_)"
          />
          <g fill="#521d39">
